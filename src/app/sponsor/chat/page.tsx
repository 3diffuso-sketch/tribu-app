...
const mockConversations = [
  { id: "c1", partnerId: "user-guia", partnerName: "Carlos Navarro", community: "Yoga & Relax", unread: 2, avatar: "", lastTime: "10:30" },
  { id: "c2", partnerId: "u-3", partnerName: "Ana Martínez", community: "Runners", unread: 0, avatar: "", lastTime: "Ayer" },
  { id: "c3", partnerId: "u-4", partnerName: "David López", community: "Fotografía", unread: 0, avatar: "", lastTime: "Lun" },
];
...
const mockMessages: Record<string, Mensaje[]> = {
  "c1": [
    ...
    { id: "m2", senderId: "user-sponsor", senderName: "Sponsor", senderAvatar: "", receiverId: "user-guia", content: "¡Claro! ¿Cuántas personas serían aproximadamente?", timestamp: "10:25", read: true },
    { id: "m3", senderId: "user-guia", senderName: "Carlos", senderAvatar: "", receiverId: "user-sponsor", content: "Seríamos unas 15 personas. Necesitamos el proyector.", timestamp: "10:30", read: false },
  ]
};
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] px-5">
      ...
      <div className="flex-1 relative overflow-hidden bg-white/40 border border-roots-sand/50 rounded-2xl flex">
        {/* List View (always visible on desktop, hidden on mobile if chat open) */}
        ...
        <div className={`w-full md:w-2/3 flex flex-col bg-white/50 ${!selectedConv ? 'hidden md:flex' : 'flex'}`}>
          {selectedConv && activePartner ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-foreground-muted p-6 text-center">
              ...
              <p className="text-sm mt-1">Selecciona una conversación para empezar a chatear con los Guías.</p>
            </div>
          )}
        </div>
      </div>
